...
public class You_Lost_FirstAidPost extends MenuActivity {

    Button button_try_again2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lost_firstaidpost);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_try_again2:
                Intent try_again = new Intent(this, LevelFirstAidPost.class);
