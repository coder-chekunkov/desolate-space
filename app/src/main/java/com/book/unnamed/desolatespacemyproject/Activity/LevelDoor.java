...
/**
 * Created by unnamed on 28.04.2017.
 */

public class LevelDoor extends MenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_found_door);
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        textTime.setText("Найдите Выход из Комнаты за " + String.valueOf(TIME - currentTime) + " секунд");
                    }
                ...
                if (currentTime >= TIME) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Intent try_again = new Intent(LevelDoor.this, You_Lost_LevelDoor.class);
                ...
                if (isPressed) {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Intent start = new Intent(LevelDoor.this, GameActivity.class);
                            startActivity(start);
                        }
                    });
                    cancel();
