...
/**
 * Created by unnamed on 17.05.2017.
 */

public class Level_Bad_Choose extends MenuActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bad_choose);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_try_again2:
                Intent try_again = new Intent(this, GameActivity.class);
